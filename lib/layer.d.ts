...
export declare function setColor(i: number, color: number[], data: Uint8ClampedArray): void;
...
export declare function scale(img: HTMLCanvasElement | ImageBitmap | HTMLImageElement, size: {
    w: number;
    h: number;
}): Layer;
export declare function fitSize(img: ImageBitmap | HTMLImageElement, maxSize: {
    w: number;
    h: number;
}): Layer;
