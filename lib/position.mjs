...
class Position {
  ...
  isAt(cor, precision = 0.1) {
    return this.cor.x - precision <= cor.x && this.cor.x + precision >= cor.x &&
           this.cor.y - precision <= cor.y && this.cor.y + precision >= cor.y &&
           this.cor.z - precision <= cor.z && this.cor.z + precision >= cor.z
  }
}
