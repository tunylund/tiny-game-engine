...
tap.test('should define a grid matrix of available size', (test: any) => {
...
tap.test('should snap to center of grid tile', (test: any) => {
...
tap.test('should snap to the center of nearest corner tile when out of bounds of the grid', (test: any) => {
...
tap.test('should snap to grid crossection', (test: any) => {
...
tap.test('should snap to the nearest corner tile when out of bounds of the grid', (test: any) => {
  const p1 = xyz(48, 48, 48), p2 = xyz(-48, -48, -48)
...
tap.test('should assign a value on the grid matrix', (test: any) => {
...
tap.test('should map matrix location to grid tile center', (test: any) => {
